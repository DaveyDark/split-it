...
void _transactionSerialize(
  ...
  writer.writeLong(offsets[1], object.contributor);
...
Transaction _transactionDeserialize(
  ...
  object.contributor = reader.readLong(offsets[1]);
...
extension TransactionQuerySortBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByContributor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contributor', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByContributorDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQuerySortThenBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByContributor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contributor', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByContributorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contributor', Sort.desc);
    });
  }
...
extension TransactionQueryWhereDistinct
  ...
  QueryBuilder<Transaction, Transaction, QDistinct> distinctByContributor() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'contributor');
    });
  }
...
extension TransactionQueryProperty
  ...
  QueryBuilder<Transaction, int, QQueryOperations> contributorProperty() {
    return QueryBuilder.apply(this, (query) {
